...
class _JoinePageState extends State<JoinePage> {
  ...
  CollectionReference ref = FirebaseFirestore.instance.collection("organisations");
  @override
            ...
            builder: (context,AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              itemBuilder: (_, index){
                ...
                return GestureDetector(
                  onTap: (){
                   Navigator.push(context, MaterialPageRoute(builder: (_)=> JoineAvailableQue(nameOfOrg: snapshot.data.docs[index].id,)));
                  },
                  child: Card(
