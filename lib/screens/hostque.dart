...
class _HostQuePageState extends State<HostQuePage> {
  ...
  Widget build(BuildContext context) {
    CollectionReference ref = FirebaseFirestore.instance.collection("organisations").doc(widget.nameOforganiationtransfer).collection("que");
    return Scaffold(
                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10,),
                              Text(snapshot.data.docs[index].id, style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal, 
